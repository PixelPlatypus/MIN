    ...
    <div className="pt-32 pb-24 container mx-auto px-6 max-w-4xl">
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="space-y-4">
          ...
          <p className="text-auto-tertiary text-sm">Last Updated: April 2026</p>
        </div>
        ...
        <div className="prose dark:prose-invert max-w-none space-y-12">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="glass p-8 rounded-3xl space-y-4">
                ...
                <p className="text-sm text-auto-secondary">
                  We use basic analytics tools to understand how visitors interact with our 
          ...
          <section className="space-y-6">
            ...
            <p className="text-lg text-auto-secondary leading-relaxed">
              We may use third-party services like Cloudinary that may set 
