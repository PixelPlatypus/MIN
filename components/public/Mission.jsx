...
const features = [
  { 
    ...
    desc: 'Breaking barriers to ensure every student in Nepal has access to quality math education.',
    icon: <CheckCircle2 className="text-primary" />
  },
  { 
    title: 'Engaging Programs', 
    desc: 'From olympiads to bootcamps, we make math fun, challenging, and relevant.',
    icon: <Award className="text-cyan" />
  },
  { 
    title: 'Goal Oriented', 
    desc: 'Empowering students with problem-solving skills for their future careers.',
    icon: <Target className="text-purple" />
  },
  { 
    title: 'Community First', 
    desc: 'Building a supportive network of educators, volunteers, and math enthusiasts.',
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        >
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight leading-tight">
              Empowering the next generation of <span className="text-primary">thinkers and problem solvers</span>.
            </h2>
            <p className="text-lg text-text-secondary dark:text-text-secondary-dark leading-relaxed">
              At MIN, we believe that mathematics is more than just numbers and formulas. 
              It's a powerful tool for understanding the world, driving innovation, 
              and creating impact. Our mission is to inspire a love for math across Nepal.
            </p>
          </div>
        ...
        >
          ...
          <div className="absolute -bottom-6 -right-6 glass p-6 rounded-3xl shadow-xl max-w-[200px] z-20 hidden sm:block">
            <p className="text-sm font-bold leading-tight mb-2">Recognized Globally</p>
            <p className="text-xs text-text-secondary dark:text-text-secondary-dark">Top 100 Global Education Innovations by HundrED.</p>
          </div>
        </motion.div>
      </div>
    </section>
