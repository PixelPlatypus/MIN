...
<head>
  <style>
    ...
    .social-icon { display: inline-block; width: 44px; height: 44px; background: #f9fafb; border-radius: 14px; text-align: center; margin-right: 12px; border: 1px solid #f3f4f6; vertical-align: middle; }
  ...
  <div class="container">
    ...
    <div class="signature">
      ...
      <div class="social-links">
        ${facebook ? `<a href="${facebook}" class="social-icon"><img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="FB" /></a>` : ''}
        ${instagram ? `<a href="${instagram}" class="social-icon"><img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" alt="IG" /></a>` : ''}
        ${linkedin ? `<a href="${linkedin}" class="social-icon"><img src="https://cdn-icons-png.flaticon.com/512/3536/3536505.png" alt="LI" /></a>` : ''}
        ${youtube ? `<a href="${youtube}" class="social-icon"><img src="https://cdn-icons-png.flaticon.com/512/1384/1384060.png" alt="YT" /></a>` : ''}
        <a href="${prodUrl}" class="social-icon"><img src="https://cdn-icons-png.flaticon.com/512/14022/14022634.png" alt="WEB" /></a>
      </div>
    </div>
  ...
  try {
    ...
    const templates = {
      'submission_received': {
        ...
        body: `## Hello {{applicant_name}},\n\nThank you for reaching out to **Mathematics Initiatives in Nepal (MIN)**. We have received your {{role_type}} and our team will review it shortly.\n\nWe appreciate your interest in supporting mathematics education in Nepal!`
      },
      ...
      'inquiry_received': {
        ...
        body: `## Thank you for reaching out, {{applicant_name}}!\n\nWe have received your message and will get back to you as soon as possible, usually within 1-5 business days.\n\n**Your Message:**\n> {{contact_message}}`
      },
      'inquiry_responded': {
      ...
      'partnership_submission': {
        subject: 'Partnership Inquiry Received — MIN Nepal',
        body: `## Hello {{applicant_name}},\n\nThank you for your interest in partnering with MIN Nepal. We have received your inquiry and our partnership team will reach out to schedule a discussion.`
      },
      'partnership_accepted': {
        subject: '🤝 Partnership Confirmed — MIN Nepal',
        body: `## It's Official!\n\nWe are honored to welcome you as a formal partner of MIN Nepal. Let's work together to transform mathematics education.`
      },
      'application_received': { 
        subject: 'We received your application — MIN Nepal',
        body: `## Hello {{applicant_name}},\n\nThank you for your interest in joining **Mathematics Initiatives in Nepal (MIN)**. We have received your application for the role of **{{role_type}}**.\n\nOur team is currently reviewing all submissions and we will get back to you soon.`
      },
      'intake_reopened': {
        subject: '🚀 Intake is now OPEN — MIN Nepal',
        body: `## Good News, {{applicant_name}}!\n\nYou asked us to notify you when the **{{role_type}}** intake opens, and that time is now.\n\nApplications are officially being accepted for the current batch. We encourage you to submit yours while the window is open!\n\n**Apply Here:** https://www.mathsinitiatives.org.np/join/{{slug}}`
      }
    }
